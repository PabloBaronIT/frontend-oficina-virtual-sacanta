<template>
  <div style="position: relative">
    ...
    <div class="row" style="margin-left: 4vw; margin-top: 7vw">
      <h5 style="margin-left: 2vw">{{ this.$route.params.sectorTitle }}</h5>
      <h1 class="tituloPrincipal">
        ...
        <h4 style="color: #4b4a49; font-weight: 100; margin-top: 1rem">
          ...
          limpieza en algún lugar en particular
        </h4>
      </h1>
    </div>
    <div class="row">
    ...
    <div class="volver">
      <div style="display: flex; flex-direction: row">
        <router-link
          :to="`/sector/${this.$route.params.sectorTitle}/${this.sectorId}`"
        >
          <svg
...
export default {
  ...
  created() {
    ...
    console.log(this.sectorId, "sectorid");
  },
};
</script>
<style scoped>
